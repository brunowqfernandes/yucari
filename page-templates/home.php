      ...
      ?>
         <section class="hero scrolling-container" style="background-image: url(<?php echo $bg_src ?>);">
            ...
            <div class="flex justify-center items-center absolute left-4 bottom-4">
               <a class="text-lg leading-none border border-white text-white py-4 px-8 flex justify-center items-center w-[20rem] max-w-full" href="<?php echo esc_url($shop_page_url) ?>">Shop</a>
            </div>
         </section>
      <?php endwhile; ?>
   <?php endif; ?>
